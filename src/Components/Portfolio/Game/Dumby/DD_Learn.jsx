    ...
    return (
        <div>
            <ul className={"list-disc pl-5"}>
                ...
                <li>Use of Scriptable Objects to allow designers to create  <span onClick={() => onKeywordClick("/CrewData.cs", "csharp")} className=" font-bold cursor-pointer underline">customizable characters</span>   directly</li>
                <li>Creation of particle effects for the ship trails</li>
                <li>Use of <span onClick={() => onKeywordClick("/RaycastTarget.cs", "csharp")} className=" font-bold cursor-pointer underline">raycasting </span>to change the material of the enemy ship</li>
                <li><span onClick={() => onKeywordClick("/AudioManager.cs", "csharp")} className=" font-bold cursor-pointer underline">AudioManager </span>for management sound in-game</li>
